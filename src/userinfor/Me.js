...
import {View, Text,StyleSheet,FlatList,Image,Dimensions,TouchableOpacity,AsyncStorage,ScrollView} from 'react-native';
        ...
        return (
            <View>
                ...
                <TouchableOpacity onPress={()=>{
                    ...
                    <Text style={{fontSize:12,color:'red',marginTop:25,textAlign:'center'}}>
                        BINNU DHILLON  |  退出登录
                    </Text>
                </TouchableOpacity>
                </ScrollView>
